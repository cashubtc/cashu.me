      ...
      <div class="max-w-6xl mx-auto text-center">
            ...
            <table class="min-w-full text-left">
              ...
              <tbody class="text-sm">
                ...
                >
                  ...
                  <td class="p-4">{{ item[selectedPerspective] }}</td>
                </tr>
              </tbody>
            </table>
          </div>
        ...
        <div class="md:hidden space-y-4">
          ...
          >
            ...
            <p class="text-sm">{{ item[selectedPerspective] }}</p>
          </div>
        </div>
      </div>
    </section>
    ...
    <section id="trust" class="py-16 px-4 fade-in-section">
      <div class="max-w-6xl mx-auto text-center">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
          <!-- Card 1 -->
          <div class="interactive-card p-6 text-left flex flex-col">
            <div class="text-4xl mb-4">🐙</div>
...
const selectedPerspective = ref("fan");
