<template>
  <q-page :class="[$q.dark.isActive ? 'bg-dark text-white' : 'bg-white text-dark', 'q-pa-md']">
    ...
    <nav class="about-toc q-mb-md">
      <ul>
        <li v-for="section in sections" :key="section.id">
          <a href="#" @click.prevent="scrollToSection(section)">{{ section.label }}</a>
        </li>
      </ul>
    </nav>
      ...
      >
        <div class="q-mt-md">
          ...
          <ul>
            ...
            <li>
              <strong>Creators</strong> set “Income”, “Escrow” (timelocked tokens) and “Operating costs” buckets to keep
              business clean.
            </li>
            <li>
              <strong>Good to know:</strong> Moving sats <strong>never</strong> touches the blockchain; it’s just local
              bookkeeping.
            </li>
          </ul>
          ...
          <ul>
            <li>
              <strong>Fans</strong> – tap ➕ in a DM to send 10 sats with your message. Fundstr auto-wraps them in a P2PK lock so
              nobody but your friend can steal them.
            </li>
            <li>
              <strong>Creators</strong> – receive tips right in the conversation; Fundstr pops a
              <em>“Thanks for the zap!”</em> ribbon and files the sats in your chosen bucket.
            </li>
          </ul>
          ...
          <ul>
            <li>
              See circulating supply, key-rotation dates and swap histogram. If a mint behaves oddly Fundstr shows a red ⚠️
              banner.
            </li>
            <li>
          ...
          <ul>
            <li>
              Fans scan a pairing QR on any website → Fundstr handles future payments without copy-pasting invoices.
            </li>
            <li>
          ...
          <div style="display:grid;grid-template-columns:50% 50%;gap:1rem;">
            ...
            <ol>
              ...
              <li>
                Watch first nutzap roll in, auto-redeem to “Income” bucket; thank supporter in chat.
              </li>
            </ol>
          </div>
        </div>
      ...
      >
        <div class="q-mt-md">
          ...
          <details>
            ...
            <b>Creator view »</b> Their timelocked token never unlocks for you, so there’s nothing to redeem. Fundstr flags the
            user as “Expired” and hides future paid posts.<br /><br />
          ...
          <details>
            ...
            Yes. Go to <em>Wallet → Send → Lightning Invoice</em>, paste the invoice from any external wallet; Fundstr melts the
      ...
      >
        <div class="q-mt-md">
          ...
          <ul>
            ...
            <h2 id="section-7" class="q-mt-lg">7 Open-source &amp; configuration</h2>
          <p v-html="$t('AboutPage.license_section')"></p>
          <p>{{ $t('AboutPage.advanced_settings') }}</p>
          <hr />
          <blockquote>
            Fundstr is powered by open-source code and an open community. Whether you’re a
            <strong>storyteller earning sats</strong> or a <strong>fan supporting work you love</strong>, we hope this guide helps
            you navigate every page with confidence — and makes your next payment feel as effortless as a like, comment, or
            retweet.
          </blockquote>
        </div>
      </q-expansion-item>
    ...
    <q-page-sticky
      ...
      scroll-target="body"
    >
      <q-btn fab icon="keyboard_arrow_up" @click="scrollToTop" aria-label="Back to Top" />
    </q-page-sticky>
  </q-page>
</template>
...
const sections = [
  { id: 'section-1', label: '1 How Fundstr works in one minute', expansion: introRef },
  { id: 'section-2', label: '2 Navigation map — every page explained', expansion: featuresRef },
  { id: 'section-3', label: '3 Feature deep-dive', expansion: featuresRef },
  { id: 'section-4', label: '4 Creator & Fan workflows', expansion: featuresRef },
  { id: 'section-5', label: '5 Frequently asked (split view)', expansion: faqRef },
  { id: 'section-6', label: '6 Stay safe & thrive', expansion: securityRef },
  { id: 'section-7', label: '7 Open-source & configuration', expansion: securityRef },
];
