export default {
  ...
  Settings: {
    ...
    backup_restore: {
      backup_seed: {
        ...
        description: "يمكن لعبارة الاستعادة الخاصة بك استعادة محفظتك. احتفظ بها آمنة وخصوصية.",
        seed_phrase_label: "عبارة الاستعادة",
      },
      restore_ecash: {
        title: "استعادة ecash",
        description: "يسمح لك معالج الاستعادة باستعادة ecash المفقودة من عبارة استعادة تذكيرية. لن تتأثر عبارة استعادة محفظتك الحالية، وسيسمح لك المعالج فقط <i>باستعادة</i> ecash من عبارة استعادة أخرى.",
        button: "استعادة"
      }
    },
    lightning_address: {
    ...
    payment_requests: {
      title: "طلبات الدفع",
      description: "تسمح لك طلبات الدفع بتلقي المدفوعات عبر nostr. إذا قمت بتمكين هذا، ستقوم محفظتك بالاشتراك في مرحلات nostr الخاصة بك.",
    ...
    nostr_wallet_connect: {
      ...
      payments_note: "يمكنك فقط استخدام NWC للمدفوعات من رصيد Bitcoin الخاص بك. ستتم المدفوعات من mint النشط الخاص بك.",
      connection: {
      ...
      relays: {
        ...
        add: {
          title: "إضافة مرحل",
          description: "يستخدم Nostr Wallet Connect مرحلات nostr لربط محفظتك بتطبيقات أخرى."
        },
        list: {
          title: "مرحلات",
    ...
    hardware_features: {
      webnfc: {
        ...
        binary: {
          title: "ثنائي خام",
          description: "بايتات خام بدلاً من Base64. يجعل الرموز أقصر بحوالي 33%."
        },
        quick_access: {
          toggle: "وصول سريع إلى NFC",
          description: "مسح بطاقات NFC بسرعة في قائمة استلام Ecash. يضيف هذا الخيار زر NFC إلى قائمة استلام Ecash."
        }
      }
    },
    p2pk_features: {
      title: "P2PK",
      description: "إنشاء زوج مفاتيح لاستلام ecash مقفلة بـ P2PK. تحذير: هذه الميزة تجريبية. استخدمها بكميات صغيرة فقط. إذا فقدت مفاتيحك الخاصة، فلن يتمكن أحد من فتح ecash المقفلة بها بعد الآن.",
      generate_button: "إنشاء مفتاح",
      import_button: "استيراد nsec",
      quick_access: {
        toggle: "وصول سريع للقفل",
        description: "استخدم هذا لعرض مفتاح قفل P2PK الخاص بك بسرعة في قائمة استلام ecash."
      },
      keys_expansion: {
    ...
    privacy: {
      ...
      check_incoming: {
        ...
        description: "إذا تم تمكين هذا، ستقوم المحفظة بفحص أحدث فاتورة في الخلفية. يزيد هذا من استجابة المحفظة مما يسهل عملية البصمة. يمكنك التحقق من الفواتير غير المدفوعة يدويًا في علامة التبويب الفواتير."
      },
      check_startup: {
        toggle: "التحقق من الفواتير المعلقة عند بدء التشغيل",
        description: "إذا تم تمكين هذا، ستقوم المحفظة بفحص الفواتير المعلقة من آخر 24 ساعة عند بدء التشغيل."
      },
      check_all: {
        toggle: "التحقق من جميع الفواتير",
        description: "إذا تم تمكين هذا، ستقوم المحفظة بالتحقق بشكل دوري من الفواتير غير المدفوعة في الخلفية لمدة تصل إلى أسبوعين. يزيد هذا من نشاط المحفظة عبر الإنترنت مما يسهل عملية البصمة. يمكنك التحقق من الفواتير غير المدفوعة يدويًا في علامة التبويب الفواتير."
      },
      check_sent: {
        toggle: "التحقق من ecash المرسلة",
        description: "إذا تم تمكين هذا، ستقوم المحفظة باستخدام فحوصات خلفية دورية لتحديد ما إذا تم استرداد الرموز المرسلة. يزيد هذا من نشاط المحفظة عبر الإنترنت مما يسهل عملية البصمة."
      },
      websockets: {
        toggle: "استخدام WebSockets",
        description: "إذا تم تمكين هذا، ستقوم المحفظة باستخدام اتصالات WebSocket طويلة الأمد لاستلام التحديثات حول الفواتير المدفوعة والرموز المستخدمة من mints. يزيد هذا من استجابة المحفظة ولكنه يسهل أيضًا عملية البصمة."
      },
      bitcoin_price: {
        toggle: "الحصول على سعر الصرف من Coinbase",
        description: "إذا تم تمكين هذا، سيتم جلب سعر صرف Bitcoin الحالي من coinbase.com وسيتم عرض رصيدك المحول."
      }
    },
    experimental: {
      title: "تجريبي",
      ...
      receive_swaps: {
        ...
        badge: "بيتا",
        description: "خيار تبديل Ecash المستلم إلى mint النشط الخاص بك في مربع حوار استلام Ecash."
      },
      auto_paste: {
        toggle: "لصق Ecash تلقائيًا",
        description: "لصق ecash تلقائيًا في الحافظة الخاصة بك عند الضغط على استلام، ثم Ecash، ثم لصق. قد يتسبب اللصق التلقائي في مشاكل في واجهة المستخدم في iOS، قم بإيقاف تشغيله إذا واجهت مشاكل."
      },
      auditor: {
        toggle: "تمكين المدقق",
        badge: "بيتا",
        description: "إذا تم تمكين هذا، ستعرض المحفظة معلومات المدقق في مربع حوار تفاصيل mint. المدقق هو خدمة طرف ثالث تراقب موثوقية mints.",
    ...
    appearance: {
      keyboard: {
        ...
        toggle_description: "إذا تم تمكين هذا، سيتم استخدام لوحة المفاتيح الرقمية لإدخال المبالغ."
      },
      theme: {
        title: "المظهر",
    ...
    advanced: {
      ...
      developer: {
        ...
        new_seed: {
          ...
          description: "سيؤدي هذا إلى إنشاء عبارة استعادة جديدة. يجب عليك إرسال رصيدك بالكامل إلى نفسك لتتمكن من استعادته باستخدام عبارة استعادة جديدة.",
        ...
        remove_spent: {
          ...
          description: "تحقق مما إذا كانت رموز ecash من mints النشطة الخاصة بك قد تم استخدامها وإزالة المستخدمة من محفظتك. استخدم هذا فقط إذا كانت محفظتك عالقة.",
        },
        debug_console: {
          button: "تبديل وحدة تحكم التصحيح",
          description: "افتح طرفية تصحيح Javascript. لا تلصق أبدًا أي شيء في هذه الطرفية لا تفهمه. قد يحاول لص خداعك للصق رمز ضار هنا.",
        },
        export_proofs: {
          button: "تصدير البراهين النشطة",
          description: "نسخ رصيدك بالكامل من mint النشط كرمز Cashu إلى الحافظة الخاصة بك. سيؤدي هذا فقط إلى تصدير الرموز من mint والوحدة المحددة. لتصدير كامل، حدد mint ووحدة مختلفين وقم بالتصدير مرة أخرى.",
        },
        keyset_counters: {
          title: "زيادة عدادات مجموعة المفاتيح",
          description: "انقر على معرّف مجموعة المفاتيح لزيادة عدادات مسار الاشتقاق لمجموعات المفاتيح في محفظتك. هذا مفيد إذا رأيت خطأ \"النواتج تم توقيعها بالفعل\".",
        },
        unset_reserved: {
          button: "إلغاء تعيين جميع الرموز المحجوزة",
          description: "تضع هذه المحفظة علامة على ecash الصادرة المعلقة كمحجوزة (وتطرحها من رصيدك) لمنع محاولات الإنفاق المزدوج. هذا الزر سيلغي تعيين جميع الرموز المحجوزة بحيث يمكن استخدامها مرة أخرى. إذا قمت بذلك، قد تتضمن محفظتك براهين مستخدمة. اضغط على زر \"إزالة البراهين المستخدمة\" للتخلص منها.",
        },
        show_onboarding: {
        ...
        reset_wallet: {
          ...
          description: "إعادة تعيين بيانات محفظتك. تحذير: سيؤدي هذا إلى حذف كل شيء! تأكد من إنشاء نسخة احتياطية أولاً.",
        ...
        export_wallet: {
          ...
          description: "تنزيل نسخة من محفظتك. يمكنك استعادة محفظتك من هذا الملف في شاشة الترحيب لمحفظة جديدة. سيكون هذا الملف غير متزامن إذا واصلت استخدام محفظتك بعد تصديره.",
        },
      },
    },
  },
  ...
  ReceiveDialog: {
    ...
    actions: {
      ...
      lightning: {
        label: "Lightning",
        error_no_mints:
          "تحتاج إلى الاتصال بـ mint لاستلام عبر Lightning",
      },
    },
  },
  ReceiveEcashDrawer: {
  ...
  PayInvoiceDialog: {
    ...
    lnurlpay: {
      ...
      amount_range_label:
        "{ payee } يطلب{br}بين { min } و { max } { ticker }",
      inputs: {
        amount: {
          label: "المبلغ ({ ticker }) *",
        },
