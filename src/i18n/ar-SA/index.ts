export default {
  ...
  Settings: {
    ...
    backup_restore: {
      ...
      restore_ecash: {
        title: "استعادة ecash",
        description: "يتيح لك معالج الاستعادة استرداد ecash المفقود من عبارة استعادة. لن تتأثر عبارة استعادة محفظتك الحالية، وسيسمح لك المعالج فقط باستعادة ecash من عبارة استعادة أخرى.",
        button: "استعادة"
      }
    },
    lightning_address: {
