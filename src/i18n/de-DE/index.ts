export default {
  ...
  wallet: {
    notifications: {
      ...
      payment_pending_refresh: "Zahlung ausstehend. Rechnung manuell aktualisieren.",
  ...
  Settings: {
    language: {
      title: "Sprache",
      description: "Bitte wählen Sie Ihre bevorzugte Sprache aus der Liste unten.",
    },
    sections: {
    ...
    backup_restore: {
      backup_seed: {
        ...
        description: "Ihre Seed-Phrase kann Ihre Wallet wiederherstellen. Bewahren Sie sie sicher und privat auf.",
    ...
    nostr_keys: {
      ...
      description: "Legen Sie die Nostr-Schlüssel für Ihre Lightning-Adresse fest.",
      wallet_seed: {
    ...
    payment_requests: {
      ...
      description: "Zahlungsanforderungen ermöglichen es Ihnen, Zahlungen über Nostr zu empfangen. Wenn Sie dies aktivieren, abonniert Ihre Wallet Ihre Nostr-Relays.",
    ...
    nostr_wallet_connect: {
      ...
      description: "Verwenden Sie NWC, um Ihre Wallet von jeder anderen Anwendung aus zu steuern.",
      enable_toggle: "NWC aktivieren",
      payments_note: "Sie können NWC nur für Zahlungen von Ihrem Bitcoin-Guthaben verwenden. Zahlungen werden von Ihrer aktiven Mint vorgenommen.",
      connection: {
      ...
      relays: {
        ...
        add: {
          ...
          description: "Nostr Wallet Connect verwendet Nostr-Relays, um Ihre Wallet mit anderen Anwendungen zu verbinden."
        },
        list: {
          title: "Relays",
    ...
    hardware_features: {
      webnfc: {
        title: "WebNFC",
        description: "Wählen Sie die Kodierung für das Schreiben auf NFC-Karten",
        text: {
          title: "Text",
        ...
        binary: {
          ...
          description: "Rohe Bytes anstelle von Base64. Macht Token ~33% kürzer."
        },
        quick_access: {
          toggle: "Schnellzugriff auf NFC",
          description: "Schnelles Scannen von NFC-Karten im Ecash empfangen-Menü. Diese Option fügt einen NFC-Button zum Ecash empfangen-Menü hinzu."
        }
      }
    },
    p2pk_features: {
      title: "P2PK",
      description: "Generieren Sie ein Schlüsselpaar, um P2PK-gesperrten Ecash zu erhalten. Warnung: Diese Funktion ist experimentell. Nur mit kleinen Beträgen verwenden. Wenn Sie Ihre privaten Schlüssel verlieren, kann niemand mehr den darauf gesperrten Ecash freischalten.",
      generate_button: "Schlüssel generieren",
      import_button: "Nsec importieren",
      quick_access: {
        toggle: "Schnellzugriff auf Sperre",
        description: "Verwenden Sie dies, um Ihren P2PK-Sperrschlüssel schnell im Ecash empfangen-Menü anzuzeigen."
      },
      keys_expansion: {
    ...
    privacy: {
      ...
      check_incoming: {
        ...
        description: "Wenn aktiviert, prüft die Wallet die neueste Rechnung im Hintergrund. Dies erhöht die Reaktionsfähigkeit der Wallet, was das Fingerprinting erleichtert. Sie können unbezahlte Rechnungen manuell im Reiter 'Rechnungen' prüfen."
      },
      check_startup: {
        toggle: "Ausstehende Rechnungen beim Start prüfen",
        description: "Wenn aktiviert, prüft die Wallet beim Start ausstehende Rechnungen der letzten 24 Stunden."
      },
      check_all: {
        toggle: "Alle Rechnungen prüfen",
        description: "Wenn aktiviert, prüft die Wallet unbezahlte Rechnungen im Hintergrund für bis zu zwei Wochen. Dies erhöht die Online-Aktivität der Wallet, was das Fingerprinting erleichtert. Sie können unbezahlte Rechnungen manuell im Reiter 'Rechnungen' prüfen."
      },
      check_sent: {
        toggle: "Gesendeten Ecash prüfen",
        description: "Wenn aktiviert, verwendet die Wallet periodische Hintergrundprüfungen, um festzustellen, ob gesendete Token eingelöst wurden. Dies erhöht die Online-Aktivität der Wallet, was das Fingerprinting erleichtert."
      },
      websockets: {
        toggle: "WebSockets verwenden",
        description: "Wenn aktiviert, verwendet die Wallet langlebige WebSocket-Verbindungen, um Updates zu bezahlten Rechnungen und ausgegebenen Token von Mints zu erhalten. Dies erhöht die Reaktionsfähigkeit der Wallet, macht aber auch das Fingerprinting einfacher."
      },
      bitcoin_price: {
        toggle: "Wechselkurs von Coinbase abrufen",
        description: "Wenn aktiviert, wird der aktuelle Bitcoin-Wechselkurs von coinbase.com abgerufen und Ihr umgerechnetes Guthaben angezeigt."
      }
    },
    experimental: {
      title: "Experimentell",
      ...
      receive_swaps: {
        ...
        badge: "Beta",
        description: "Option, empfangenen Ecash in Ihrer aktiven Mint im Dialog 'Ecash empfangen' zu tauschen."
      },
      auto_paste: {
        toggle: "Ecash automatisch einfügen",
        description: "Fügt Ecash automatisch aus Ihrer Zwischenablage ein, wenn Sie auf 'Empfangen', dann 'Ecash', dann 'Einfügen' drücken. Automatisches Einfügen kann auf iOS zu UI-Fehlern führen. Deaktivieren Sie dies, wenn Sie Probleme haben."
      },
      auditor: {
        toggle: "Auditor aktivieren",
        badge: "Beta",
        description: "Wenn aktiviert, zeigt die Wallet Auditor-Informationen im Dialog 'Mint-Details' an. Der Auditor ist ein Drittanbieter-Service, der die Zuverlässigkeit von Mints überwacht.",
    ...
    appearance: {
      keyboard: {
        ...
        description: "Verwenden Sie die Zifferntastatur zur Eingabe von Beträgen.",
        toggle: "Numerische Tastatur verwenden",
        toggle_description: "Wenn aktiviert, wird die numerische Tastatur zur Eingabe von Beträgen verwendet."
      },
      theme: {
        title: "Aussehen",
    ...
    advanced: {
      ...
      developer: {
        ...
        description: "Die folgenden Einstellungen sind für Entwicklung und Debugging.",
        new_seed: {
          button: "Neue Seed-Phrase generieren",
          description: "Dies generiert eine neue Seed-Phrase. Sie müssen Ihr gesamtes Guthaben an sich selbst senden, um es mit einer neuen Seed wiederherstellen zu können.",
          confirm_question: "Sind Sie sicher, dass Sie eine neue Seed-Phrase generieren möchten?",
          cancel: "Abbrechen",
          confirm: "Bestätigen"
        },
        remove_spent: {
          button: "Ausgegebene Nachweise entfernen",
          description: "Überprüfen Sie, ob die Ecash-Token von Ihren aktiven Mints ausgegeben wurden und entfernen Sie die ausgegebenen aus Ihrer Wallet. Verwenden Sie dies nur, wenn Ihre Wallet festhängt."
        },
        debug_console: {
          button: "Debug-Konsole umschalten",
          description: "Öffnen Sie das Javascript-Debug-Terminal. Fügen Sie niemals etwas in dieses Terminal ein, das Sie nicht verstehen. Ein Dieb könnte versuchen, Sie dazu zu bringen, bösartigen Code hier einzufügen."
        },
        export_proofs: {
          button: "Aktive Nachweise exportieren",
          description: "Kopieren Sie Ihr gesamtes Guthaben von der aktiven Mint als Cashu-Token in Ihre Zwischenablage. Dies exportiert nur die Token der ausgewählten Mint und Einheit. Für einen vollständigen Export wählen Sie eine andere Mint und Einheit und exportieren Sie erneut."
        },
        keyset_counters: {
          title: "Keyset-Zähler erhöhen",
          description: "Klicken Sie auf die Keyset-ID, um die Ableitungspfad-Zähler für die Keysets in Ihrer Wallet zu erhöhen. Dies ist nützlich, wenn Sie die Fehlermeldung \"outputs have already been signed\" sehen."
        },
        unset_reserved: {
        ...
        reset_wallet: {
          ...
          description: "Setzen Sie Ihre Wallet-Daten zurück. Warnung: Dies löscht alles! Stellen Sie sicher, dass Sie vorher eine Sicherung erstellen.",
          confirm_question: "Sind Sie sicher, dass Sie Ihre Wallet-Daten löschen möchten?",
          cancel: "Abbrechen",
          confirm: "Wallet löschen"
        },
        export_wallet: {
          button: "Wallet-Daten exportieren",
          description: "Laden Sie einen Dump Ihrer Wallet herunter. Sie können Ihre Wallet aus dieser Datei auf dem Willkommensbildschirm einer neuen Wallet wiederherstellen. Diese Datei ist nicht synchron, wenn Sie Ihre Wallet nach dem Export weiter verwenden."
        }
      }
    }
  },
  ...
  MintSettings: {
    ...
    discover: {
      ...
      overline: "Entdecken",
      caption: "Entdecken Sie Mints, die andere Benutzer auf Nostr empfohlen haben.",
      actions: {
        discover: {
