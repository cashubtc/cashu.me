    ...
    advanced: {
      ...
      developer: {
        ...
        export_wallet: {
          ...
          description:
            "Λήψη ενός dump του πορτοφολιού σας. Μπορείτε να επαναφέρετε το πορτοφόλι σας σύροντας και αφήνοντας αυτό το αρχείο στην οθόνη καλωσορίσματος ενός νέου πορτοφολιού. Αυτό το αρχείο θα είναι εκτός συγχρονισμού εάν συνεχίσετε να χρησιμοποιείτε το πορτοφόλι σας μετά την εξαγωγή του.",
        },
      },
    },
  },
