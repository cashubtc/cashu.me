export default {
  ...
  Settings: {
    language: {
      title: "Γλώσσα",
      description: "Παρακαλώ επιλέξτε την προτιμώμενη γλώσσα σας από την παρακάτω λίστα.",
    },
    sections: {
    ...
    backup_restore: {
      backup_seed: {
        ...
        description: "Η φράση seed σας μπορεί να επαναφέρει το πορτοφόλι σας. Κρατήστε την ασφαλή και ιδιωτική.",
        seed_phrase_label: "Φράση seed",
      },
      restore_ecash: {
        title: "Επαναφορά ecash",
        description: "Ο οδηγός επαναφοράς σάς επιτρέπει να ανακτήσετε χαμένο ecash από μια μνημονική φράση seed. Η φράση seed του τρέχοντος πορτοφολιού σας θα παραμείνει ανεπηρέαστη, ο οδηγός θα σας επιτρέψει μόνο να <i>επαναφέρετε</i> ecash από μια άλλη φράση seed.",
        button: "Επαναφορά"
      }
    },
    lightning_address: {
    ...
    nostr_keys: {
      ...
      wallet_seed: {
        ...
        description: "Δημιουργία ζεύγους κλειδιών nostr από τη seed του πορτοφολιού",
    ...
    payment_requests: {
      ...
      description: "Τα αιτήματα πληρωμής σάς επιτρέπουν να λαμβάνετε πληρωμές μέσω nostr. Εάν το ενεργοποιήσετε, το πορτοφόλι σας θα εγγραφεί στα relays nostr σας.",
    ...
    nostr_wallet_connect: {
      ...
      description: "Χρησιμοποιήστε το NWC για να ελέγξετε το πορτοφόλι σας από οποιαδήποτε άλλη εφαρμογή.",
      enable_toggle: "Ενεργοποίηση NWC",
      payments_note: "Μπορείτε να χρησιμοποιήσετε το NWC μόνο για πληρωμές από το υπόλοιπο Bitcoin σας. Οι πληρωμές θα γίνονται από το ενεργό σας mint.",
      connection: {
      ...
      relays: {
        ...
        add: {
          ...
          description: "Το Nostr Wallet Connect χρησιμοποιεί relays nostr για να συνδέσει το πορτοφόλι σας με άλλες εφαρμογές."
        },
        list: {
          title: "Relays",
    ...
    hardware_features: {
      webnfc: {
        ...
        binary: {
          ...
          description: "Ακατέργαστα bytes αντί για Base64. Κάνει τα token ~33% μικρότερα."
        },
        quick_access: {
          toggle: "Γρήγορη πρόσβαση σε NFC",
          description: "Γρήγορη σάρωση καρτών NFC στο μενού Λήψη Ecash. Αυτή η επιλογή προσθέτει ένα κουμπί NFC στο μενού Λήψη Ecash."
        }
      }
    },
    p2pk_features: {
      title: "P2PK",
      description: "Δημιουργία ζεύγους κλειδιών για λήψη ecash κλειδωμένου με P2PK. Προειδοποίηση: Αυτή η δυνατότητα είναι πειραματική. Χρησιμοποιήστε μόνο με μικρά ποσά. Εάν χάσετε τα ιδιωτικά σας κλειδιά, κανείς δεν θα μπορεί πλέον να ξεκλειδώσει το ecash που είναι κλειδωμένο σε αυτά.",
      generate_button: "Δημιουργία κλειδιού",
      import_button: "Εισαγωγή nsec",
      quick_access: {
        toggle: "Γρήγορη πρόσβαση στο κλείδωμα",
        description: "Χρησιμοποιήστε το για να εμφανίσετε γρήγορα το κλειδί κλειδώματος P2PK στο μενού λήψης ecash."
      },
      keys_expansion: {
    ...
    privacy: {
      ...
      check_incoming: {
        ...
        description: "Εάν είναι ενεργοποιημένο, το πορτοφόλι θα ελέγχει το τελευταίο τιμολόγιο στο παρασκήνιο. Αυτό αυξάνει την απόκριση του πορτοφολιού, καθιστώντας ευκολότερο το fingerprinting. Μπορείτε να ελέγξετε μη αυτόματα τα απλήρωτα τιμολόγια στην καρτέλα Τιμολόγια."
      },
      check_startup: {
        toggle: "Έλεγχος εκκρεμών τιμολογίων κατά την εκκίνηση",
        description: "Εάν είναι ενεργοποιημένο, το πορτοφόλι θα ελέγχει τα εκκρεμή τιμολόγια των τελευταίων 24 ωρών κατά την εκκίνηση."
      },
      check_all: {
        toggle: "Έλεγχος όλων των τιμολογίων",
        description: "Εάν είναι ενεργοποιημένο, το πορτοφόλι θα ελέγχει περιοδικά τα απλήρωτα τιμολόγια στο παρασκήνιο για έως και δύο εβδομάδες. Αυτό αυξάνει τη διαδικτυακή δραστηριότητα του πορτοφολιού, καθιστώντας ευκολότερο το fingerprinting. Μπορείτε να ελέγξετε μη αυτόματα τα απλήρωτα τιμολόγια στην καρτέλα Τιμολόγια."
      },
      check_sent: {
        toggle: "Έλεγχος απεσταλμένου ecash",
        description: "Εάν είναι ενεργοποιημένο, το πορτοφόλι θα χρησιμοποιεί περιοδικούς ελέγχους παρασκηνίου για να προσδιορίσει εάν τα απεσταλμένα token έχουν εξαργυρωθεί. Αυτό αυξάνει τη διαδικτυακή δραστηριότητα του πορτοφολιού, καθιστώντας ευκολότερο το fingerprinting."
      },
      websockets: {
        toggle: "Χρήση WebSockets",
        description: "Εάν είναι ενεργοποιημένο, το πορτοφόλι θα χρησιμοποιεί μακροχρόνιες συνδέσεις WebSocket για λήψη ενημερώσεων σχετικά με πληρωμένα τιμολόγια και δαπανημένα token από τα mints. Αυτό αυξάνει την απόκριση του πορτοφολιού αλλά καθιστά επίσης ευκολότερο το fingerprinting."
      },
      bitcoin_price: {
        toggle: "Λήψη συναλλαγματικής ισοτιμίας από Coinbase",
        description: "Εάν είναι ενεργοποιημένο, η τρέχουσα συναλλαγματική ισοτιμία Bitcoin θα ληφθεί από το coinbase.com και θα εμφανιστεί το μετατραπέν υπόλοιπό σας."
      }
    },
    experimental: {
      title: "Πειραματικό",
      ...
      receive_swaps: {
        ...
        badge: "Beta",
        description: "Επιλογή ανταλλαγής του ληφθέντος Ecash στο ενεργό σας mint στον διάλογο Λήψη Ecash."
      },
      auto_paste: {
        toggle: "Αυτόματη επικόλληση Ecash",
        description: "Αυτόματη επικόλληση του ecash στο πρόχειρό σας όταν πατάτε Λήψη, μετά Ecash, μετά Επικόλληση. Η αυτόματη επικόλληση μπορεί να προκαλέσει δυσλειτουργίες στο UI στο iOS, απενεργοποιήστε την εάν αντιμετωπίζετε προβλήματα."
      },
      auditor: {
        toggle: "Ενεργοποίηση ελεγκτή",
        badge: "Beta",
        description: "Εάν είναι ενεργοποιημένο, το πορτοφόλι θα εμφανίζει πληροφορίες ελεγκτή στον διάλογο λεπτομερειών του mint. Ο ελεγκτής είναι μια υπηρεσία τρίτου μέρους που παρακολουθεί την αξιοπιστία των mints.",
    ...
    appearance: {
      keyboard: {
        ...
        description: "Χρησιμοποιήστε το αριθμητικό πληκτρολόγιο για την εισαγωγή ποσών.",
        toggle: "Χρήση αριθμητικού πληκτρολογίου",
        toggle_description: "Εάν είναι ενεργοποιημένο, θα χρησιμοποιείται το αριθμητικό πληκτρολόγιο για την εισαγωγή ποσών."
      },
      theme: {
        title: "Εμφάνιση",
    ...
    advanced: {
      ...
      developer: {
        ...
        description: "Οι ακόλουθες ρυθμίσεις είναι για ανάπτυξη και εντοπισμό σφαλμάτων.",
        new_seed: {
          button: "Δημιουργία νέας φράσης seed",
          description: "Αυτό θα δημιουργήσει μια νέα φράση seed. Πρέπει να στείλετε ολόκληρο το υπόλοιπό σας στον εαυτό σας για να μπορέσετε να το επαναφέρετε με μια νέα seed.",
          confirm_question: "Είστε βέβαιοι ότι θέλετε να δημιουργήσετε μια νέα φράση seed;",
          cancel: "Ακύρωση",
          confirm: "Επιβεβαίωση"
        },
        remove_spent: {
          button: "Αφαίρεση δαπανημένων αποδείξεων",
          description: "Ελέγξτε εάν τα token ecash από τα ενεργά σας mints έχουν δαπανηθεί και αφαιρέστε τα δαπανημένα από το πορτοφόλι σας. Χρησιμοποιήστε το μόνο εάν το πορτοφόλι σας έχει κολλήσει."
        },
        debug_console: {
          button: "Εναλλαγή Κονσόλας Εντοπισμού Σφαλμάτων",
          description: "Ανοίξτε το τερματικό εντοπισμού σφαλμάτων Javascript. Ποτέ μην επικολλάτε τίποτα σε αυτό το τερματικό που δεν καταλαβαίνετε. Ένας κλέφτης μπορεί να προσπαθήσει να σας εξαπατήσει για να επικολλήσετε κακόβουλο κώδικα εδώ."
        },
        export_proofs: {
          button: "Εξαγωγή ενεργών αποδείξεων",
          description: "Αντιγράψτε ολόκληρο το υπόλοιπό σας από το ενεργό mint ως token Cashu στο πρόχειρό σας. Αυτό θα εξάγει μόνο τα token από το επιλεγμένο mint και μονάδα. Για πλήρη εξαγωγή, επιλέξτε διαφορετικό mint και μονάδα και εξάγετε ξανά."
        },
        keyset_counters: {
          title: "Αύξηση μετρητών keyset",
          description: "Κάντε κλικ στο ID του keyset για να αυξήσετε τους μετρητές διαδρομής παραγωγής για τα keysets στο πορτοφόλι σας. Αυτό είναι χρήσιμο εάν βλέπετε το σφάλμα \"οι εξόδοι έχουν ήδη υπογραφεί\"."
        },
        unset_reserved: {
          button: "Κατάργηση δέσμευσης όλων των δεσμευμένων token",
          description: "Αυτό το πορτοφόλι επισημαίνει το εκκρεμές εξερχόμενο ecash ως δεσμευμένο (και το αφαιρεί από το υπόλοιπό σας) για να αποτρέψει προσπάθειες διπλής δαπάνης. Αυτό το κουμπί θα καταργήσει τη δέσμευση όλων των δεσμευμένων token ώστε να μπορούν να χρησιμοποιηθούν ξανά. Εάν το κάνετε αυτό, το πορτοφόλι σας μπορεί να περιλαμβάνει δαπανημένες αποδείξεις. Πατήστε το κουμπί \"Αφαίρεση δαπανημένων αποδείξεων\" για να τις αφαιρέσετε."
        },
        show_onboarding: {
        ...
        reset_wallet: {
          ...
          description: "Επαναφορά των δεδομένων του πορτοφολιού σας. Προειδοποίηση: Αυτό θα διαγράψει τα πάντα! Βεβαιωθείτε ότι έχετε δημιουργήσει πρώτα ένα αντίγραφο ασφαλείας.",
          confirm_question: "Είστε βέβαιοι ότι θέλετε να διαγράψετε τα δεδομένα του πορτοφολιού σας;",
          cancel: "Ακύρωση",
          confirm: "Διαγραφή πορτοφολιού"
        },
        export_wallet: {
          button: "Εξαγωγή δεδομένων πορτοφολιού",
          description: "Λήψη ενός dump του πορτοφολιού σας. Μπορείτε να επαναφέρετε το πορτοφόλι σας από αυτό το αρχείο στην οθόνη καλωσορίσματος ενός νέου πορτοφολιού. Αυτό το αρχείο θα είναι εκτός συγχρονισμού εάν συνεχίσετε να χρησιμοποιείτε το πορτοφόλι σας μετά την εξαγωγή του."
        }
      }
    }
  },
