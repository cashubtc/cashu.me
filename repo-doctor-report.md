...
<details><summary>Stash list</summary>

```
stash@{0}: WIP on (no branch): b5c17ec Merge pull request #568 from ritty65/wmynsv-codex/add-early-return-to-maybeconvertnpub
stash@{1}: On Phase5: WIP before merging PRs into Phase5
stash@{2}: On Phase5: WIP Phase5 local edits
stash@{3}: On phase5: WIP: before creating Phase5 at merge commit
```
</details>
...
|---|---|---:|---:|---|
 ...
 |  `Phase6` | origin/Phase6 | 0 | 4 | 2025-06-18T09:11:08+02:00 |
 ...
 |  `test/fix-shims` | origin/test/fix-shims | 0 | 0 | 2025-08-07T19:18:27+02:00 |
...
<details><summary>optimizeDeps hints</summary>

```
quasar.config.js:42: optimizeDeps: { include: ['process', 'buffer'] },
quasar.config.js:70: viteConf.optimizeDeps = { ...(viteConf.optimizeDeps || {}), include: [ ...(viteConf.optimizeDeps?.include || []), 'buffer', 'process' ] };
```
</details>
